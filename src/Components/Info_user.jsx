    ...
    if(USUARIO){
        ...
        useEffect(() => {
            ...
            try {
                ...
                const response1 = await axios.post('https://gana-back.vercel.app/apiv1/info_user_tabla', {iduser});
            ...
            const CargarInfoUser = async () => {
                try {
                    ...
                    const response2 = await axios.post('https://gana-back.vercel.app/apiv1/info_user', {user});
            ...
            const CargarAccessLogin = async () => {
                try {
                    const user = localStorage.getItem("user"); //obtengo el (usuario) del usuario autenticado  del local storage
                    const response3 = await axios.post('https://gana-back.vercel.app/apiv1/info_audit_users', {user});
        ...
        const RegistraCodigo = async (e) => {
            ...
            try {
                const response = await fetch('https://gana-back.vercel.app/apiv1/update_codigo', {
                method: 'POST',
                headers: {
                ...
                window.alert(result.status);  // información del estado del codigo registrado
                    ...
                    try {
                        //Recargo la tabla
                        const iduser = localStorage.getItem("id"); //obtengo el (ID) del usuario autenticado  del local storage
                        const response = await axios.post('https://gana-back.vercel.app/apiv1/info_user_tabla', {iduser})
